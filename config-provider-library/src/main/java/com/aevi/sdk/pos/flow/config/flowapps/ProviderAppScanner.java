...
public class ProviderAppScanner {
    ...
    @Inject
    public ProviderAppScanner(ProviderAppDatabase appDatabase, PaymentFlowServiceScanner flowServiceScanner, ProviderFlowConfigStore providerFlowConfigStore,
